...
// startLogTail follows a container's logs and publishes each line to Redis
// channel `container-logs:<projectId>`. Returns a cancel func — call when the
// container is stopped/destroyed to free the goroutine + redis client.
